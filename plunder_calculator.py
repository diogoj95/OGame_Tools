#OGame Plunder Calculator v0.1
#Â© Copyright 2017 Diogo Queiroz. All Rights Reserved.
...
c_res=int(input('Current resources: '))
...
print('{} Small Cargo Ships'.format(int(req_sc_ships)))
print('or')
print('{} Large Cargo Ships'.format(int(req_lc_ships)))
print('in order to be able to plunder all available resources')
